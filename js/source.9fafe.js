...
/* harmony import */ var react_hot_loader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(137);
/* harmony import */ var react_hot_loader__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react_hot_loader__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var components_Scheduler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(138);
var _dec, _class;
...
let App = (_dec = Object(react_hot_loader__WEBPACK_IMPORTED_MODULE_1__["hot"])(module), _dec(_class = class App extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  render() {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(components_Scheduler__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], null);
  }
...
var v1 = __webpack_require__(151);
var v4 = __webpack_require__(152);
...
var styles_m = __webpack_require__(3);
...
var uuid = __webpack_require__(134);
...
var classnames = __webpack_require__(135);
...
class Task_Task extends react["PureComponent"] {
  constructor(...args) {
    ...
    this._updateTaskMessageOnKeyDown = e => {
  ...
  render() {
    ...
    return react_default.a.createElement("li", {
      className: classnames_default()(styles_m_default.a.task, {
        [styles_m_default.a.completed]: completed
      })
    }, react_default.a.createElement("div", {
      className: styles_m_default.a.content
    }, react_default.a.createElement(assets_Checkbox, {
      className: styles_m_default.a.toggleTaskCompletedState,
      inlineBlock: true,
      color1: "#3B8EF3",
      color2: "#FFF",
      checked: completed,
      ...
      className: styles_m_default.a.toggleTaskFavoriteState,
      inlineBlock: true,
      color1: '#3B8EF3',
      color2: '#000',
      checked: favorite,
      ...
      className: styles_m_default.a.updateTaskMessageOnClick,
      inlineBlock: true,
      color1: '#3B8EF3',
      color2: '#000',
...
Task_Task.propTypes = {
  ...
  completed: prop_types["bool"].isRequired,
  favorite: prop_types["bool"].isRequired,
  message: prop_types["string"].isRequired,
  _updateTaskAsync: prop_types["func"].isRequired,
  _removeTaskAsync: prop_types["func"].isRequired
};
// EXTERNAL MODULE: ./source/components/Spinner/styles.m.css
var Spinner_styles_m = __webpack_require__(136);
...
var Scheduler_styles_m = __webpack_require__(5);
var Scheduler_styles_m_default = /*#__PURE__*/__webpack_require__.n(Scheduler_styles_m);

// CONCATENATED MODULE: ./source/REST/config.js
const ROOT_URL = 'https://lab.lectrum.io';
const MAIN_URL = `${ROOT_URL}/hw/todo/api`;
const TOKEN = 'sZBKYkaQqHtJjT1D';
...
const api = {
  ...
  async createTask(newTaskMessage) {
    const newTask = new helpers_BaseTaskModel();
    newTask.message = newTaskMessage;
    newTask.created = moment_default()().unix();
    const response = await fetch(MAIN_URL, {
      method: 'POST',
      headers: {
        Authorization: TOKEN,
  ...
  async completeAllTasks(tasks) {
    const promiseAll = await Promise.all(tasks.map(async task => {
      task.completed = true;
      const response = await fetch(MAIN_URL, {
        method: 'PUT',
        headers: {
...
class Scheduler_Scheduler extends react["Component"] {
  constructor(...args) {
    ...
    this._updateTaskAsync = async taskToUpdate => {
      try {
        this._setTasksFetchingState(true);
  ...
  render() {
    ...
    const tasksJSX = tasks.map(task => {
      ...
      return react_default.a.createElement(Task_Task, Scheduler_extends({
    ...
    return react_default.a.createElement("section", {
    ...
    }, react_default.a.createElement(components_Spinner, {
      ...
      typeName: "div"
    }, tasksJSX)))), react_default.a.createElement("footer", null, react_default.a.createElement(assets_Checkbox, {
      color1: '#363636',
      color2: '#fff',
...
/* harmony import */ var _theme_init__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(145);
...
/* harmony import */ var _pages_App__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(133);
// Core
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.9fafe.js.map